...
.method addIndicator(Landroid/widget/TextView;I)V
    ...
    .line 370
    new-instance v0, Lo/AssertionError;

    iget-object v2, p0, Lcom/google/android/material/textfield/IndicatorViewController;->context:Landroid/content/Context;

    invoke-direct {v0, v2}, Lo/AssertionError;-><init>(Landroid/content/Context;)V
...
.method adjustIndicatorPadding()V
    ...
    invoke-static {v1}, Lo/FilterWriter;->j(Landroid/view/View;)I
    ...
    invoke-static {v2}, Lo/FilterWriter;->g(Landroid/view/View;)I
    ...
    .line 345
    invoke-static {v0, v1, v3, v2, v3}, Lo/FilterWriter;->a(Landroid/view/View;IIII)V
...
.method setHelperTextEnabled(Z)V
    ...
    invoke-static {v1, v0}, Lo/FilterWriter;->d(Landroid/view/View;I)V
