...
.method static zaa(Landroid/app/Activity;Landroid/app/Dialog;Ljava/lang/String;Landroid/content/DialogInterface$OnCancelListener;)V
    ...
    .line 124
    instance-of v0, p0, Lo/Serializable;
    ...
    .line 130
    invoke-virtual {p1, p0, p2}, Lcom/google/android/gms/common/SupportErrorDialogFragment;->show(Lo/SerializablePermission;Ljava/lang/String;)V
...
.method private final zaa(Landroid/content/Context;ILjava/lang/String;Landroid/app/PendingIntent;)V
    ...
    invoke-direct {v3, p1}, Lo/OnGenericMotionListener$Activity;-><init>(Landroid/content/Context;)V

    const/4 v4, 0x1

    .line 149
    invoke-virtual {v3, v4}, Lo/OnGenericMotionListener$Activity;->g(Z)Lo/OnGenericMotionListener$Activity;

    move-result-object v3

    .line 150
    invoke-virtual {v3, v4}, Lo/OnGenericMotionListener$Activity;->c(Z)Lo/OnGenericMotionListener$Activity;

    move-result-object v3

    .line 151
    invoke-virtual {v3, p3}, Lo/OnGenericMotionListener$Activity;->a(Ljava/lang/CharSequence;)Lo/OnGenericMotionListener$Activity;

    move-result-object p3

    new-instance v3, Lo/OnGenericMotionListener$ActionBar;

    invoke-direct {v3}, Lo/OnGenericMotionListener$ActionBar;-><init>()V

    .line 152
    invoke-virtual {v3, v0}, Lo/OnGenericMotionListener$ActionBar;->d(Ljava/lang/CharSequence;)Lo/OnGenericMotionListener$ActionBar;

    move-result-object v3

    invoke-virtual {p3, v3}, Lo/OnGenericMotionListener$Activity;->d(Lo/OnGenericMotionListener$Application;)Lo/OnGenericMotionListener$Activity;
    ...
    invoke-virtual {p3, v0}, Lo/OnGenericMotionListener$Activity;->c(I)Lo/OnGenericMotionListener$Activity;

    move-result-object v0

    .line 157
    invoke-virtual {v0, v5}, Lo/OnGenericMotionListener$Activity;->d(I)Lo/OnGenericMotionListener$Activity;
    ...
    .line 161
    invoke-virtual {p3, v0, v1, p4}, Lo/OnGenericMotionListener$Activity;->d(ILjava/lang/CharSequence;Landroid/app/PendingIntent;)Lo/OnGenericMotionListener$Activity;

    goto :goto_0

    .line 162
    :cond_3
    invoke-virtual {p3, p4}, Lo/OnGenericMotionListener$Activity;->e(Landroid/app/PendingIntent;)Lo/OnGenericMotionListener$Activity;
    ...
    .line 164
    invoke-virtual {p3, v3}, Lo/OnGenericMotionListener$Activity;->c(I)Lo/OnGenericMotionListener$Activity;
    ...
    invoke-virtual {v3, v1}, Lo/OnGenericMotionListener$Activity;->b(Ljava/lang/CharSequence;)Lo/OnGenericMotionListener$Activity;
    ...
    invoke-virtual {v1, v6, v7}, Lo/OnGenericMotionListener$Activity;->b(J)Lo/OnGenericMotionListener$Activity;

    move-result-object v1

    .line 167
    invoke-virtual {v1, p4}, Lo/OnGenericMotionListener$Activity;->e(Landroid/app/PendingIntent;)Lo/OnGenericMotionListener$Activity;

    move-result-object p4

    .line 168
    invoke-virtual {p4, v0}, Lo/OnGenericMotionListener$Activity;->e(Ljava/lang/CharSequence;)Lo/OnGenericMotionListener$Activity;
    ...
    :cond_6
    :goto_1
    invoke-virtual {p3, p4}, Lo/OnGenericMotionListener$Activity;->a(Ljava/lang/String;)Lo/OnGenericMotionListener$Activity;

    .line 188
    :cond_7
    invoke-virtual {p3}, Lo/OnGenericMotionListener$Activity;->c()Landroid/app/Notification;
