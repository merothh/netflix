...
.field private mRemoteUserInfo:Lo/IllegalStateException$StateListAnimator;
...
.field private mVolumeCallback:Lo/InstantiationError$TaskDescription;

.field mVolumeProvider:Lo/InstantiationError;
...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;Landroid/content/ComponentName;Landroid/app/PendingIntent;)V
    ...
    iput-object v1, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mVolumeCallback:Lo/InstantiationError$TaskDescription;
...
.method adjustVolume(II)V
    ...
    .line 2502
    iget-object p2, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mVolumeProvider:Lo/InstantiationError;

    if-eqz p2, :cond_1

    .line 2503
    invoke-virtual {p2, p1}, Lo/InstantiationError;->e(I)V
...
.method public getCurrentControllerInfo()Lo/IllegalStateException$StateListAnimator;
    .locals 2
    ...
    .line 2433
    :try_start_0
    iget-object v1, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mRemoteUserInfo:Lo/IllegalStateException$StateListAnimator;
...
.method public setCurrentControllerInfo(Lo/IllegalStateException$StateListAnimator;)V
    .locals 1
    ...
    .line 2440
    :try_start_0
    iput-object p1, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mRemoteUserInfo:Lo/IllegalStateException$StateListAnimator;
...
.method public setPlaybackToLocal(I)V
    ...
    .line 2103
    iget-object v0, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mVolumeProvider:Lo/InstantiationError;
    ...
    .line 2104
    invoke-virtual {v0, v1}, Lo/InstantiationError;->d(Lo/InstantiationError$TaskDescription;)V
...
.method public setPlaybackToRemote(Lo/InstantiationError;)V
    .locals 7
    ...
    .line 2124
    iput-object p1, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mVolumeProvider:Lo/InstantiationError;
    ...
    iget-object v1, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mVolumeProvider:Lo/InstantiationError;

    .line 2126
    invoke-virtual {v1}, Lo/InstantiationError;->d()I

    move-result v4

    iget-object v1, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mVolumeProvider:Lo/InstantiationError;

    invoke-virtual {v1}, Lo/InstantiationError;->c()I
    ...
    .line 2127
    invoke-virtual {v1}, Lo/InstantiationError;->b()I
    ...
    .line 2130
    iget-object v0, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mVolumeCallback:Lo/InstantiationError$TaskDescription;

    invoke-virtual {p1, v0}, Lo/InstantiationError;->d(Lo/InstantiationError$TaskDescription;)V
...
.method setVolumeTo(II)V
    ...
    .line 2513
    invoke-virtual {p2, p1}, Lo/InstantiationError;->b(I)V
