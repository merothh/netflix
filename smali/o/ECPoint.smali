...
.method private static a(Landroid/content/Context;Landroid/content/res/Resources;Landroid/content/res/Resources$Theme;Lorg/xmlpull/v1/XmlPullParser;)Landroid/view/animation/Interpolator;
    ...
    .line 141
    new-instance v0, Lo/KeySpec;

    invoke-direct {v0, p0, p2, p3}, Lo/KeySpec;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;Lorg/xmlpull/v1/XmlPullParser;)V
...
.method public static d(Landroid/content/Context;I)Landroid/view/animation/Interpolator;
    ...
    .line 75
    :try_start_0
    new-instance p0, Lo/AbstractMethodError;

    invoke-direct {p0}, Lo/AbstractMethodError;-><init>()V
    ...
    .line 77
    new-instance p0, Lo/Appendable;

    invoke-direct {p0}, Lo/Appendable;-><init>()V
    ...
    .line 79
    new-instance p0, Lo/Boolean;

    invoke-direct {p0}, Lo/Boolean;-><init>()V
    ...
    invoke-static {p0, v1, v3, v0}, Lo/ECPoint;->a(Landroid/content/Context;Landroid/content/res/Resources;Landroid/content/res/Resources$Theme;Lorg/xmlpull/v1/XmlPullParser;)Landroid/view/animation/Interpolator;
