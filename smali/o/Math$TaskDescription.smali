...
.method constructor <init>(Landroid/content/Context;Landroid/content/Intent;Landroid/content/BroadcastReceiver$PendingResult;)V
    ...
    .line 144
    iput-object p1, p0, Lo/Math$TaskDescription;->b:Landroid/content/Context;

    .line 145
    iput-object p2, p0, Lo/Math$TaskDescription;->e:Landroid/content/Intent;

    .line 146
    iput-object p3, p0, Lo/Math$TaskDescription;->c:Landroid/content/BroadcastReceiver$PendingResult;
...
.method private e()V
    ...
    .line 177
    iget-object v0, p0, Lo/Math$TaskDescription;->d:Landroid/support/v4/media/MediaBrowserCompat;

    invoke-virtual {v0}, Landroid/support/v4/media/MediaBrowserCompat;->disconnect()V

    .line 178
    iget-object v0, p0, Lo/Math$TaskDescription;->c:Landroid/content/BroadcastReceiver$PendingResult;
...
.method b(Landroid/support/v4/media/MediaBrowserCompat;)V
    ...
    .line 150
    iput-object p1, p0, Lo/Math$TaskDescription;->d:Landroid/support/v4/media/MediaBrowserCompat;
...
.method public onConnected()V
    ...
    iget-object v1, p0, Lo/Math$TaskDescription;->b:Landroid/content/Context;

    iget-object v2, p0, Lo/Math$TaskDescription;->d:Landroid/support/v4/media/MediaBrowserCompat;
    ...
    .line 158
    iget-object v1, p0, Lo/Math$TaskDescription;->e:Landroid/content/Intent;
    ...
    .line 163
    :goto_0
    invoke-direct {p0}, Lo/Math$TaskDescription;->e()V
