...
.method public onCloseMenu(Lo/Mode;Z)V
    ...
    invoke-virtual {v0}, Landroidx/appcompat/widget/ActionMenuPresenter;->getCallback()Lo/MediaController$StateListAnimator;
...
.method public onOpenSubMenu(Lo/Mode;)Z
    ...
    check-cast v2, Lo/IBinder;

    invoke-virtual {v2}, Lo/IBinder;->getItem()Landroid/view/MenuItem;
    ...
    invoke-virtual {v1}, Landroidx/appcompat/widget/ActionMenuPresenter;->getCallback()Lo/MediaController$StateListAnimator;
    ...
    .line 778
    invoke-interface {v1, p1}, Lo/MediaController$StateListAnimator;->onOpenSubMenu(Lo/Mode;)Z
