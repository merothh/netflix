...
.method public onHoverEvent(Landroid/view/MotionEvent;)Z
    ...
    check-cast v0, Lo/CursorFactory;
    ...
    .line 204
    invoke-virtual {v0}, Lo/CursorFactory;->getCount()I
    ...
    .line 205
    invoke-virtual {v0, v3}, Lo/CursorFactory;->c(I)Lo/Rect;
    ...
    .line 212
    invoke-virtual {v0}, Lo/CursorFactory;->e()Lo/Mode;
    ...
    invoke-interface {v3, v0, v1}, Landroidx/appcompat/widget/MenuItemHoverListener;->onItemHoverExit(Lo/Mode;Landroid/view/MenuItem;)V
    ...
    invoke-interface {v1, v0, v2}, Landroidx/appcompat/widget/MenuItemHoverListener;->onItemHoverEnter(Lo/Mode;Landroid/view/MenuItem;)V
...
.method public onKeyDown(ILandroid/view/KeyEvent;)Z
    ...
    .line 164
    invoke-virtual {v0}, Lo/Canvas;->isEnabled()Z

    move-result p1

    if-eqz p1, :cond_0

    invoke-virtual {v0}, Lo/Canvas;->getItemData()Lo/Rect;
    ...
    check-cast p1, Lo/CursorFactory;

    invoke-virtual {p1}, Lo/CursorFactory;->e()Lo/Mode;

    move-result-object p1

    const/4 p2, 0x0

    invoke-virtual {p1, p2}, Lo/Mode;->close(Z)V
