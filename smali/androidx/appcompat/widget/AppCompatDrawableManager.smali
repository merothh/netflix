...
# instance fields
.field private mDelegates:Lo/Spanned;
...
.field private mKnownDrawableIdTags:Lo/TransformationMethod;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method static constructor <clinit>()V
    ...
    .line 113
    sget v3, Lo/LoaderManager$Application;->R:I

    const/4 v4, 0x0

    aput v3, v2, v4

    sget v3, Lo/LoaderManager$Application;->P:I

    const/4 v5, 0x1

    aput v3, v2, v5

    sget v3, Lo/LoaderManager$Application;->c:I
    ...
    .line 123
    sget v7, Lo/LoaderManager$Application;->m:I

    aput v7, v3, v4

    sget v7, Lo/LoaderManager$Application;->D:I

    aput v7, v3, v5

    sget v7, Lo/LoaderManager$Application;->r:I

    aput v7, v3, v6

    sget v7, Lo/LoaderManager$Application;->o:I

    aput v7, v3, v0

    sget v7, Lo/LoaderManager$Application;->n:I

    const/4 v8, 0x4

    aput v7, v3, v8

    sget v7, Lo/LoaderManager$Application;->q:I

    const/4 v9, 0x5

    aput v7, v3, v9

    sget v7, Lo/LoaderManager$Application;->s:I
    ...
    .line 137
    sget v7, Lo/LoaderManager$Application;->J:I
    ...
    sget v7, Lo/LoaderManager$Application;->F:I

    aput v7, v3, v0

    sget v7, Lo/LoaderManager$Application;->E:I
    ...
    sget v7, Lo/LoaderManager$Application;->K:I

    aput v7, v3, v1

    sget v1, Lo/LoaderManager$Application;->G:I

    aput v1, v3, v2

    sget v1, Lo/LoaderManager$Application;->L:I

    const/16 v2, 0x8

    aput v1, v3, v2

    sget v1, Lo/LoaderManager$Application;->N:I
    ...
    .line 154
    sget v1, Lo/LoaderManager$Application;->v:I
    ...
    sget v1, Lo/LoaderManager$Application;->p:I
    ...
    .line 164
    sget v1, Lo/LoaderManager$Application;->I:I

    aput v1, v0, v4

    sget v1, Lo/LoaderManager$Application;->O:I
    ...
    .line 174
    sget v1, Lo/LoaderManager$Application;->e:I
...
.method private addDelegate(Ljava/lang/String;Landroidx/appcompat/widget/AppCompatDrawableManager$InflateDelegate;)V
    ...
    .line 489
    iget-object v0, p0, Landroidx/appcompat/widget/AppCompatDrawableManager;->mDelegates:Lo/Spanned;
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/AppCompatDrawableManager;->mDelegates:Lo/Spanned;
...
.method private declared-synchronized addDrawableToCache(Landroid/content/Context;JLandroid/graphics/drawable/Drawable;)Z
    ...
    invoke-virtual {v0, p2, p3, p1}, Lo/Params;->b(JLjava/lang/Object;)V
    :try_end_0
...
.method private addTintListToCache(Landroid/content/Context;ILandroid/content/res/ColorStateList;)V
    ...
    check-cast v0, Lo/TransformationMethod;
    ...
    .line 576
    :cond_1
    invoke-virtual {v0, p2, p3}, Lo/TransformationMethod;->c(ILjava/lang/Object;)V
...
.method private checkVectorDrawableSetup(Landroid/content/Context;)V
    ...
    .line 753
    sget v0, Lo/LoaderManager$Application;->S:I
...
.method private createButtonColorStateList(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    .line 600
    sget v2, Lo/LoaderManager$StateListAnimator;->y:I
    ...
    .line 601
    sget v3, Lo/LoaderManager$StateListAnimator;->x:I
    ...
    .line 609
    invoke-static {v2, p2}, Lo/WindowId;->e(II)I
...
.method private createColoredButtonColorStateList(Landroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    .line 590
    sget v0, Lo/LoaderManager$StateListAnimator;->u:I
...
.method private createDefaultButtonColorStateList(Landroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    .line 580
    sget v0, Lo/LoaderManager$StateListAnimator;->x:I
...
.method private createDrawableIfNeeded(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    .line 245
    :cond_1
    sget v5, Lo/LoaderManager$Application;->f:I
    ...
    sget v6, Lo/LoaderManager$Application;->g:I
    ...
    sget v5, Lo/LoaderManager$Application;->j:I
...
.method private createSwitchThumbColorStateList(Landroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    .line 629
    sget v2, Lo/LoaderManager$StateListAnimator;->z:I
    ...
    .line 642
    sget v5, Lo/LoaderManager$StateListAnimator;->v:I
    ...
    .line 658
    sget v2, Lo/LoaderManager$StateListAnimator;->v:I
...
.method private declared-synchronized getCachedDrawable(Landroid/content/Context;J)Landroid/graphics/drawable/Drawable;
    ...
    :cond_0
    :try_start_1
    invoke-virtual {v0, p2, p3}, Lo/Params;->c(J)Ljava/lang/Object;
    ...
    :cond_1
    :try_start_2
    invoke-virtual {v0, p2, p3}, Lo/Params;->b(J)V
    :try_end_2
...
.method private getTintListFromCache(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    check-cast p1, Lo/TransformationMethod;

    if-eqz p1, :cond_0

    .line 561
    invoke-virtual {p1, p2}, Lo/TransformationMethod;->e(I)Ljava/lang/Object;
...
.method static getTintMode(I)Landroid/graphics/PorterDuff$Mode;
    ...
    .line 513
    sget v0, Lo/LoaderManager$Application;->C:I
...
.method private static isVectorDrawable(Landroid/graphics/drawable/Drawable;)Z
    ...
    .line 762
    instance-of v0, p0, Lo/PKCS8EncodedKeySpec;
...
.method private loadDrawableFromDelegates(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v0}, Lo/Spanned;->isEmpty()Z
    ...
    .line 309
    iget-object v0, p0, Landroidx/appcompat/widget/AppCompatDrawableManager;->mKnownDrawableIdTags:Lo/TransformationMethod;
    ...
    .line 310
    invoke-virtual {v0, p2}, Lo/TransformationMethod;->e(I)Ljava/lang/Object;
    ...
    iget-object v3, p0, Landroidx/appcompat/widget/AppCompatDrawableManager;->mDelegates:Lo/Spanned;

    .line 312
    invoke-virtual {v3, v0}, Lo/Spanned;->get(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/AppCompatDrawableManager;->mKnownDrawableIdTags:Lo/TransformationMethod;
    ...
    .line 361
    iget-object v8, p0, Landroidx/appcompat/widget/AppCompatDrawableManager;->mKnownDrawableIdTags:Lo/TransformationMethod;

    invoke-virtual {v8, p2, v3}, Lo/TransformationMethod;->c(ILjava/lang/Object;)V

    .line 364
    iget-object v8, p0, Landroidx/appcompat/widget/AppCompatDrawableManager;->mDelegates:Lo/Spanned;

    invoke-virtual {v8, v3}, Lo/Spanned;->get(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 384
    iget-object p1, p0, Landroidx/appcompat/widget/AppCompatDrawableManager;->mKnownDrawableIdTags:Lo/TransformationMethod;

    invoke-virtual {p1, p2, v2}, Lo/TransformationMethod;->c(ILjava/lang/Object;)V
...
.method private removeDelegate(Ljava/lang/String;Landroidx/appcompat/widget/AppCompatDrawableManager$InflateDelegate;)V
    ...
    .line 497
    iget-object p2, p0, Landroidx/appcompat/widget/AppCompatDrawableManager;->mDelegates:Lo/Spanned;

    invoke-virtual {p2, p1}, Lo/Spanned;->remove(Ljava/lang/Object;)Ljava/lang/Object;
...
.method private tintDrawable(Landroid/content/Context;IZLandroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    .line 269
    :cond_0
    invoke-static {p4}, Lo/AccessibilityRecord;->f(Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;

    move-result-object p4

    .line 270
    invoke-static {p4, v0}, Lo/AccessibilityRecord;->a(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;)V
    ...
    .line 275
    invoke-static {p4, p1}, Lo/AccessibilityRecord;->b(Landroid/graphics/drawable/Drawable;Landroid/graphics/PorterDuff$Mode;)V

    goto/16 :goto_1

    .line 277
    :cond_1
    sget v0, Lo/LoaderManager$Application;->A:I
    ...
    sget v0, Lo/LoaderManager$StateListAnimator;->w:I
    ...
    sget p3, Lo/LoaderManager$StateListAnimator;->v:I
    ...
    .line 285
    :cond_2
    sget v0, Lo/LoaderManager$Application;->x:I

    if-eq p2, v0, :cond_4

    sget v0, Lo/LoaderManager$Application;->u:I

    if-eq p2, v0, :cond_4

    sget v0, Lo/LoaderManager$Application;->y:I
    ...
    sget v0, Lo/LoaderManager$StateListAnimator;->v:I
...
.method static tintDrawableUsingColorFilter(Landroid/content/Context;ILandroid/graphics/drawable/Drawable;)Z
    ...
    .line 448
    sget v2, Lo/LoaderManager$StateListAnimator;->w:I
    ...
    .line 457
    :cond_2
    sget v1, Lo/LoaderManager$Application;->t:I
    ...
    .line 461
    :cond_3
    sget v1, Lo/LoaderManager$Application;->h:I
...
.method declared-synchronized getTintList(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    .line 527
    sget v0, Lo/LoaderManager$Activity;->c:I

    invoke-static {p1, v0}, Lo/DialogInterface;->d(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    .line 529
    sget v0, Lo/LoaderManager$Activity;->g:I
    ...
    .line 530
    :cond_1
    sget v1, Lo/LoaderManager$Application;->C:I
    ...
    .line 532
    :cond_2
    sget v1, Lo/LoaderManager$Application;->b:I
    ...
    .line 534
    :cond_3
    sget v1, Lo/LoaderManager$Application;->a:I
    ...
    .line 536
    :cond_4
    sget v1, Lo/LoaderManager$Application;->d:I
    ...
    .line 538
    :cond_5
    sget v1, Lo/LoaderManager$Application;->z:I
    ...
    .line 544
    sget v0, Lo/LoaderManager$Activity;->d:I
    ...
    .line 546
    sget v0, Lo/LoaderManager$Activity;->e:I
    ...
    .line 547
    :cond_9
    sget v1, Lo/LoaderManager$Application;->w:I

    if-ne p2, v1, :cond_b

    .line 548
    sget v0, Lo/LoaderManager$Activity;->a:I
    ...
    :cond_a
    :goto_0
    sget v0, Lo/LoaderManager$Activity;->j:I
