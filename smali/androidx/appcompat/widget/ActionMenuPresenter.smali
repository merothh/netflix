...
# interfaces
.implements Lo/DataInput$Activity;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 88
    sget v0, Lo/LoaderManager$PendingIntent;->a:I

    sget v1, Lo/LoaderManager$PendingIntent;->e:I

    invoke-direct {p0, p1, v0, v1}, Lo/Resources;-><init>(Landroid/content/Context;II)V
...
.method static synthetic access$000(Landroidx/appcompat/widget/ActionMenuPresenter;)Lo/Mode;
    .locals 0

    .line 53
    iget-object p0, p0, Landroidx/appcompat/widget/ActionMenuPresenter;->mMenu:Lo/Mode;

    return-object p0
.end method

.method static synthetic access$100(Landroidx/appcompat/widget/ActionMenuPresenter;)Lo/Mode;
    .locals 0
...
.method static synthetic access$200(Landroidx/appcompat/widget/ActionMenuPresenter;)Lo/Drawable;
    .locals 0

    .line 53
    iget-object p0, p0, Landroidx/appcompat/widget/ActionMenuPresenter;->mMenuView:Lo/Drawable;

    return-object p0
.end method

.method static synthetic access$300(Landroidx/appcompat/widget/ActionMenuPresenter;)Lo/Mode;
    .locals 0
...
.method static synthetic access$400(Landroidx/appcompat/widget/ActionMenuPresenter;)Lo/Mode;
    .locals 0
...
.method static synthetic access$500(Landroidx/appcompat/widget/ActionMenuPresenter;)Lo/Drawable;
    .locals 0
...
.method private findViewForItem(Landroid/view/MenuItem;)Landroid/view/View;
    ...
    .line 321
    iget-object v0, p0, Landroidx/appcompat/widget/ActionMenuPresenter;->mMenuView:Lo/Drawable;
    ...
    .line 327
    instance-of v5, v4, Lo/Drawable$StateListAnimator;

    if-eqz v5, :cond_1

    move-object v5, v4

    check-cast v5, Lo/Drawable$StateListAnimator;

    .line 328
    invoke-interface {v5}, Lo/Drawable$StateListAnimator;->getItemData()Lo/Rect;
...
# virtual methods
.method public bindItemView(Lo/Rect;Lo/Drawable$StateListAnimator;)V
    .locals 1

    const/4 v0, 0x0

    .line 211
    invoke-interface {p2, p1, v0}, Lo/Drawable$StateListAnimator;->initialize(Lo/Rect;I)V

    .line 213
    iget-object p1, p0, Landroidx/appcompat/widget/ActionMenuPresenter;->mMenuView:Lo/Drawable;

    check-cast p1, Landroidx/appcompat/widget/ActionMenuView;

    .line 214
    check-cast p2, Lo/Cursor;

    .line 215
    invoke-virtual {p2, p1}, Lo/Cursor;->setItemInvoker(Lo/Mode$TaskDescription;)V
    ...
    invoke-virtual {p2, p1}, Lo/Cursor;->setPopupCallback(Lo/Cursor$TaskDescription;)V
...
.method public filterLeftoverView(Landroid/view/ViewGroup;I)Z
    ...
    .line 280
    :cond_0
    invoke-super {p0, p1, p2}, Lo/Resources;->filterLeftoverView(Landroid/view/ViewGroup;I)Z
...
.method public flagActionItems()Z
    ...
    .line 421
    iget-object v1, v0, Landroidx/appcompat/widget/ActionMenuPresenter;->mMenu:Lo/Mode;
    ...
    invoke-virtual {v1}, Lo/Mode;->getVisibleItems()Ljava/util/ArrayList;
    ...
    .line 432
    iget-object v7, v0, Landroidx/appcompat/widget/ActionMenuPresenter;->mMenuView:Lo/Drawable;
    ...
    check-cast v13, Lo/Rect;

    .line 440
    invoke-virtual {v13}, Lo/Rect;->l()Z
    ...
    .line 442
    :cond_1
    invoke-virtual {v13}, Lo/Rect;->m()Z
    ...
    invoke-virtual {v13}, Lo/Rect;->isActionViewExpanded()Z
    ...
    check-cast v14, Lo/Rect;

    .line 476
    invoke-virtual {v14}, Lo/Rect;->l()Z
    ...
    invoke-virtual {v0, v14, v15, v7}, Landroidx/appcompat/widget/ActionMenuPresenter;->getItemView(Lo/Rect;Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    .line 492
    :goto_6
    invoke-virtual {v14}, Lo/Rect;->getGroupId()I
    ...
    .line 496
    :cond_b
    invoke-virtual {v14, v15}, Lo/Rect;->d(Z)V
    ...
    .line 497
    :cond_c
    invoke-virtual {v14}, Lo/Rect;->m()Z
    ...
    invoke-virtual {v0, v14, v2, v7}, Landroidx/appcompat/widget/ActionMenuPresenter;->getItemView(Lo/Rect;Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    check-cast v15, Lo/Rect;

    .line 541
    invoke-virtual {v15}, Lo/Rect;->getGroupId()I
    ...
    .line 543
    invoke-virtual {v15}, Lo/Rect;->i()Z
    ...
    .line 544
    invoke-virtual {v15, v0}, Lo/Rect;->d(Z)V
    ...
    .line 551
    :cond_1b
    invoke-virtual {v14, v2}, Lo/Rect;->d(Z)V
    ...
    .line 554
    invoke-virtual {v14, v0}, Lo/Rect;->d(Z)V
...
.method public getItemView(Lo/Rect;Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    .line 195
    invoke-virtual {p1}, Lo/Rect;->getActionView()Landroid/view/View;
    ...
    .line 197
    :cond_0
    invoke-super {p0, p1, p2, p3}, Lo/Resources;->getItemView(Lo/Rect;Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;

    move-result-object v0

    .line 199
    :cond_1
    invoke-virtual {p1}, Lo/Rect;->isActionViewExpanded()Z
...
.method public getMenuView(Landroid/view/ViewGroup;)Lo/Drawable;
    ...
    .line 186
    invoke-super {p0, p1}, Lo/Resources;->getMenuView(Landroid/view/ViewGroup;)Lo/Drawable;
...
.method public initForMenu(Landroid/content/Context;Lo/Mode;)V
    ...
    .line 93
    invoke-super {p0, p1, p2}, Lo/Resources;->initForMenu(Landroid/content/Context;Lo/Mode;)V
    ...
    .line 99
    invoke-virtual {p1}, Lo/IntentFilter;->c()Z
    ...
    .line 103
    invoke-virtual {p1}, Lo/IntentFilter;->d()I
    ...
    .line 108
    invoke-virtual {p1}, Lo/IntentFilter;->b()I
...
.method public onCloseMenu(Lo/Mode;Z)V
    ...
    .line 563
    invoke-super {p0, p1, p2}, Lo/Resources;->onCloseMenu(Lo/Mode;Z)V
...
.method public onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    .line 140
    :cond_0
    iget-object p1, p0, Landroidx/appcompat/widget/ActionMenuPresenter;->mMenu:Lo/Mode;
...
.method public onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    .line 581
    iget-object v0, p0, Landroidx/appcompat/widget/ActionMenuPresenter;->mMenu:Lo/Mode;

    iget p1, p1, Landroidx/appcompat/widget/ActionMenuPresenter$SavedState;->openSubMenuId:I

    invoke-virtual {v0, p1}, Lo/Mode;->findItem(I)Landroid/view/MenuItem;
    ...
    .line 584
    invoke-virtual {p0, p1}, Landroidx/appcompat/widget/ActionMenuPresenter;->onSubMenuSelected(Lo/IBinder;)Z
...
.method public onSubMenuSelected(Lo/IBinder;)Z
    ...
    .line 288
    :goto_0
    invoke-virtual {v0}, Lo/IBinder;->getParentMenu()Landroid/view/Menu;

    move-result-object v2

    iget-object v3, p0, Landroidx/appcompat/widget/ActionMenuPresenter;->mMenu:Lo/Mode;
    ...
    check-cast v0, Lo/IBinder;

    goto :goto_0

    .line 291
    :cond_1
    invoke-virtual {v0}, Lo/IBinder;->getItem()Landroid/view/MenuItem;
    ...
    .line 300
    :cond_2
    invoke-virtual {p1}, Lo/IBinder;->getItem()Landroid/view/MenuItem;
    ...
    .line 303
    invoke-virtual {p1}, Lo/IBinder;->size()I
    ...
    .line 305
    invoke-virtual {p1, v3}, Lo/IBinder;->getItem(I)Landroid/view/MenuItem;
    ...
    invoke-direct {v2, p0, v3, p1, v0}, Landroidx/appcompat/widget/ActionMenuPresenter$ActionButtonSubmenu;-><init>(Landroidx/appcompat/widget/ActionMenuPresenter;Landroid/content/Context;Lo/IBinder;Landroid/view/View;)V
    ...
    .line 316
    invoke-super {p0, p1}, Lo/Resources;->onSubMenuSelected(Lo/IBinder;)Z
...
.method public onSubUiVisibilityChanged(Z)V
    ...
    invoke-virtual {p1, v0}, Lo/Mode;->close(Z)V
...
.method public setMenuView(Landroidx/appcompat/widget/ActionMenuView;)V
    ...
    .line 600
    iput-object p1, p0, Landroidx/appcompat/widget/ActionMenuPresenter;->mMenuView:Lo/Drawable;

    .line 601
    iget-object v0, p0, Landroidx/appcompat/widget/ActionMenuPresenter;->mMenu:Lo/Mode;

    invoke-virtual {p1, v0}, Landroidx/appcompat/widget/ActionMenuView;->initialize(Lo/Mode;)V
...
.method public showOverflowMenu()Z
    ...
    iget-object v4, p0, Landroidx/appcompat/widget/ActionMenuPresenter;->mMenu:Lo/Mode;
    ...
    invoke-direct/range {v1 .. v6}, Landroidx/appcompat/widget/ActionMenuPresenter$OverflowPopup;-><init>(Landroidx/appcompat/widget/ActionMenuPresenter;Landroid/content/Context;Lo/Mode;Landroid/view/View;Z)V
    ...
    .line 349
    invoke-super {p0, v0}, Lo/Resources;->onSubMenuSelected(Lo/IBinder;)Z
...
.method public updateMenuView(Z)V
    ...
    .line 230
    invoke-super {p0, p1}, Lo/Resources;->updateMenuView(Z)V
    ...
    invoke-virtual {p1}, Lo/Mode;->getActionItems()Ljava/util/ArrayList;
    ...
    invoke-virtual {v3}, Lo/Rect;->b()Lo/DataInput;
    ...
    .line 240
    invoke-virtual {v3, p0}, Lo/DataInput;->setSubUiVisibilityListener(Lo/DataInput$Activity;)V
    ...
    .line 246
    invoke-virtual {p1}, Lo/Mode;->getNonActionItems()Ljava/util/ArrayList;
