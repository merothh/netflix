...
# instance fields
.field private mClickAnimation:Lo/InputStream;
...
.field private mScrollHelper:Lo/PipedOutputStream;
...
.method private clearPressedItem()V
    ...
    .line 639
    :cond_0
    iget-object v0, p0, Landroidx/appcompat/widget/DropDownListView;->mClickAnimation:Lo/InputStream;
    ...
    .line 641
    iput-object v0, p0, Landroidx/appcompat/widget/DropDownListView;->mClickAnimation:Lo/InputStream;
...
.method private positionSelectorLikeFocusCompat(ILandroid/view/View;)V
    ...
    .line 599
    invoke-static {v0, p2, p1}, Lo/AccessibilityRecord;->b(Landroid/graphics/drawable/Drawable;FF)V
...
.method private positionSelectorLikeTouchCompat(ILandroid/view/View;FF)V
    ...
    .line 579
    invoke-static {p2, p3, p4}, Lo/AccessibilityRecord;->b(Landroid/graphics/drawable/Drawable;FF)V
...
.method public onForwardedEvent(Landroid/view/MotionEvent;I)Z
    ...
    .line 525
    iget-object p2, p0, Landroidx/appcompat/widget/DropDownListView;->mScrollHelper:Lo/PipedOutputStream;

    if-nez p2, :cond_8

    .line 526
    new-instance p2, Lo/PipedOutputStream;

    invoke-direct {p2, p0}, Lo/PipedOutputStream;-><init>(Landroid/widget/ListView;)V

    iput-object p2, p0, Landroidx/appcompat/widget/DropDownListView;->mScrollHelper:Lo/PipedOutputStream;

    .line 528
    :cond_8
    iget-object p2, p0, Landroidx/appcompat/widget/DropDownListView;->mScrollHelper:Lo/PipedOutputStream;

    invoke-virtual {p2, v2}, Lo/PipedOutputStream;->e(Z)Lo/ObjectStreamClass;

    .line 529
    iget-object p2, p0, Landroidx/appcompat/widget/DropDownListView;->mScrollHelper:Lo/PipedOutputStream;

    invoke-virtual {p2, p0, p1}, Lo/PipedOutputStream;->onTouch(Landroid/view/View;Landroid/view/MotionEvent;)Z

    goto :goto_4

    .line 530
    :cond_9
    iget-object p1, p0, Landroidx/appcompat/widget/DropDownListView;->mScrollHelper:Lo/PipedOutputStream;

    if-eqz p1, :cond_a

    .line 531
    invoke-virtual {p1, v1}, Lo/PipedOutputStream;->e(Z)Lo/ObjectStreamClass;
