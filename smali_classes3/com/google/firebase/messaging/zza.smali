...
.method final zzh(Landroid/os/Bundle;)Z
    ...
    :cond_1e
    :goto_b
    new-instance v4, Lo/OnGenericMotionListener$Activity;

    iget-object v5, v0, Lcom/google/firebase/messaging/zza;->zzx:Landroid/content/Context;

    invoke-direct {v4, v5}, Lo/OnGenericMotionListener$Activity;-><init>(Landroid/content/Context;)V

    const/4 v5, 0x1

    .line 172
    invoke-virtual {v4, v5}, Lo/OnGenericMotionListener$Activity;->c(Z)Lo/OnGenericMotionListener$Activity;

    move-result-object v4

    invoke-virtual {v4, v10}, Lo/OnGenericMotionListener$Activity;->c(I)Lo/OnGenericMotionListener$Activity;
    ...
    .line 174
    invoke-virtual {v4, v2}, Lo/OnGenericMotionListener$Activity;->a(Ljava/lang/CharSequence;)Lo/OnGenericMotionListener$Activity;
    ...
    .line 176
    invoke-virtual {v4, v6}, Lo/OnGenericMotionListener$Activity;->e(Ljava/lang/CharSequence;)Lo/OnGenericMotionListener$Activity;

    .line 177
    new-instance v2, Lo/OnGenericMotionListener$ActionBar;

    invoke-direct {v2}, Lo/OnGenericMotionListener$ActionBar;-><init>()V

    invoke-virtual {v2, v6}, Lo/OnGenericMotionListener$ActionBar;->d(Ljava/lang/CharSequence;)Lo/OnGenericMotionListener$ActionBar;

    move-result-object v2

    invoke-virtual {v4, v2}, Lo/OnGenericMotionListener$Activity;->d(Lo/OnGenericMotionListener$Application;)Lo/OnGenericMotionListener$Activity;
    ...
    invoke-virtual {v4, v2}, Lo/OnGenericMotionListener$Activity;->b(I)Lo/OnGenericMotionListener$Activity;

    :cond_21
    if-eqz v8, :cond_22

    .line 181
    invoke-virtual {v4, v8}, Lo/OnGenericMotionListener$Activity;->d(Landroid/net/Uri;)Lo/OnGenericMotionListener$Activity;

    :cond_22
    if-eqz v12, :cond_23

    .line 183
    invoke-virtual {v4, v12}, Lo/OnGenericMotionListener$Activity;->e(Landroid/app/PendingIntent;)Lo/OnGenericMotionListener$Activity;

    :cond_23
    if-eqz v3, :cond_24

    .line 185
    invoke-virtual {v4, v3}, Lo/OnGenericMotionListener$Activity;->a(Landroid/app/PendingIntent;)Lo/OnGenericMotionListener$Activity;

    :cond_24
    if-eqz v15, :cond_25

    .line 187
    invoke-virtual {v4, v15}, Lo/OnGenericMotionListener$Activity;->a(Ljava/lang/String;)Lo/OnGenericMotionListener$Activity;

    .line 188
    :cond_25
    invoke-virtual {v4}, Lo/OnGenericMotionListener$Activity;->c()Landroid/app/Notification;
