...
.method public static b(Lio/reactivex/CompletableSource;)Lcom/uber/autodispose/AutoDisposeConverter;
    .locals 1
    ...
    .line 112
    invoke-static {p0, v0}, Lcom/uber/autodispose/AutoDisposeUtil;->d(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/Object;
...
.method private static synthetic b(Lcom/uber/autodispose/ScopeProvider;)Lio/reactivex/CompletableSource;
    ...
    .line 83
    :try_start_0
    invoke-interface {p0}, Lcom/uber/autodispose/ScopeProvider;->e()Lio/reactivex/CompletableSource;
...
.method public static d(Lcom/uber/autodispose/ScopeProvider;)Lcom/uber/autodispose/AutoDisposeConverter;
    ...
    invoke-direct {v0, p0}, Lo/aji;-><init>(Lcom/uber/autodispose/ScopeProvider;)V

    invoke-static {v0}, Lio/reactivex/Completable;->defer(Ljava/util/concurrent/Callable;)Lio/reactivex/Completable;

    move-result-object p0

    invoke-static {p0}, Lcom/uber/autodispose/AutoDispose;->b(Lio/reactivex/CompletableSource;)Lcom/uber/autodispose/AutoDisposeConverter;
...
.method public static synthetic e(Lcom/uber/autodispose/ScopeProvider;)Lio/reactivex/CompletableSource;
    .locals 0

    invoke-static {p0}, Lcom/uber/autodispose/AutoDispose;->b(Lcom/uber/autodispose/ScopeProvider;)Lio/reactivex/CompletableSource;
